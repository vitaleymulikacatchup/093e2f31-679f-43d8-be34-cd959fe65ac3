...
export const metadata: Metadata = {
  title: "Borsch & Beyond - Authentic Ukrainian Restaurant",
  description: "Experience traditional Ukrainian cuisine at Borsch & Beyond. Authentic recipes, fresh ingredients, and warm hospitality in every dish. Book your table today.",
  keywords: "Ukrainian restaurant, Ukrainian food, borscht, varenyky, authentic cuisine, traditional recipes, Ukrainian culture",
  metadataBase: new URL("https://borschandbeyond.com"),
  alternates: {
    canonical: "https://borschandbeyond.com"
  },
  openGraph: {
    title: "Borsch & Beyond - Authentic Ukrainian Restaurant",
    description: "Experience traditional Ukrainian cuisine with authentic recipes and warm hospitality",
    siteName: "Borsch & Beyond",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763727398035-ct0pswyf.jpg",
        alt: "Traditional Ukrainian restaurant interior"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Borsch & Beyond - Authentic Ukrainian Restaurant",
    description: "Experience traditional Ukrainian cuisine with authentic recipes and warm hospitality",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763727398035-ct0pswyf.jpg"]
  },
  robots: {
    index: true,
    follow: true
